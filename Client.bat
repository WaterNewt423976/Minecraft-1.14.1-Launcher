...
start "" /D "%DIR%" /I /HIGH "%JAVA%" %JAVA_OPTIONS% --version 1.14.4 --gameDir . --assetsDir assets --assetIndex 1.14 --accessToken 1337535510N --userType legacy --versionType release --uuid %uuid% --username %NICK% 
